...
#define CY_BLE_CONFIG_L2CAP_ENABLE                  (1u)
    ...
    /** L2CAP MTU Size. */
    #define CY_BLE_CONFIG_L2CAP_MTU                     (512u)
...
#define CY_BLE_FSR_FORCE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
